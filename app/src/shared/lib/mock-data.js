...
export const MOCK_REVIEWS = [
  {
    ...
    score_service: 3.5, score_visual: 2.5, score_access: 4.0,
  ...
  },
  {
    ...
    score_service: 4.5, score_visual: 5.0, score_access: 3.5,
  ...
  },
  {
    ...
    score_service: 3.5, score_visual: 3.5, score_access: 4.5,
  ...
  },
  {
    ...
    score_service: 4.0, score_visual: 2.0, score_access: 5.0,
  ...
  },
  {
    ...
    score_service: 4.5, score_visual: 5.0, score_access: 4.0,
  ...
  },
  {
    ...
    score_service: 4.0, score_visual: 3.0, score_access: 4.0,
    ...
    .map(review => {
      ...
      const totalScore = +(
        (review.score_taste + review.score_value + review.score_atmosphere +
         review.score_service + review.score_visual + review.score_access) / 6
      ).toFixed(2)
...
export function getMockRestaurantAvg(restaurantId) {
  ...
  const keys = ['score_taste', 'score_value', 'score_atmosphere', 'score_service', 'score_visual', 'score_access']
  const avg = {}
  keys.forEach(k => {
